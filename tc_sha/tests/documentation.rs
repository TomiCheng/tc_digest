...
fn every_digest_and_crate_visible_helper_has_an_unambiguous_timing_doc() {
    for (name, source) in [
        ...
        ("sha1.rs", include_str!("../src/sha1.rs")),
        ("sha224.rs", include_str!("../src/sha224.rs")),
        ("sha256.rs", include_str!("../src/sha256.rs")),
        ("sha256_core.rs", include_str!("../src/sha256_core.rs")),
        ("sha384.rs", include_str!("../src/sha384.rs")),
        ("sha512.rs", include_str!("../src/sha512.rs")),
        ("sha512_core.rs", include_str!("../src/sha512_core.rs")),
        ("sha512t.rs", include_str!("../src/sha512t.rs")),
    ] {
